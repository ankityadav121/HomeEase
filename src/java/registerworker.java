    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
         ...
         try{
             ...
             if(wemail.equals(tableEmail)){
               ...
               String query="INSERT INTO worker values(1,'"+wemail+"','"+wname+"','"+wpassword+"','"+wphone+"','"+waadhar+"','"+waddressproof+"','"+waddress+"','"+wjoiningdate+"','"+wcategory+"','"+wrating+"','"+wage+"','"+warea+"','"+wlocation+"','"+wprofile+"')";
